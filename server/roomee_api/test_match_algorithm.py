...
def test_match():
    ...
    answer_list = [(1, 1, 1, 4), (2, 1, 2, 2), (3, 2, 1, 3), (4, 2, 2, 3),(1, 23, 1, 1), (1, 24, 1, 3),(2,23,2,0),(2, 24, 2, 3),(1, 11, 1, 1), (2, 12, 2, 1),(1, 11, 2, 1), (2, 12, 1, 1),(1, 14, 1, 1), (2, 15, 2, 1),(1, 14, 2, 1), (2, 15, 1, 1)]
    user1 = (1, 'Alice')
    user=(2, 'Bob')
    expected_high = [(2, 'Bob'),(1, 'Alice')]
    high, med, low = match(user1, user_list, answer_list)
