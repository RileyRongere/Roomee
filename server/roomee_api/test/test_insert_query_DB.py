# Authored by Lane Affield, Emma Gerdeman, Nick Wharff, Nick Peters
...
def test_query_all_questions():
    my_sql = mySQL()
    question2 = "test_question2"
    my_sql.insert_question(question2)
    questions = my_sql.query_all_questions()
    assert type(questions) is list
    # QUESTIONS should have more than one element b/c of tests
